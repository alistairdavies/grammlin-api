...
This application uses the following third-party data sources:

## Folkets Lexikon (People's Dictionary)

**Source**: https://folkets-lexikon.csc.kth.se/folkets/folkets.en.html
...
Swedish pipeline optimized for CPU, trained on written web text and Universal Dependencies treebank.
